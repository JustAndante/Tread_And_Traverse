...
description: "Detailed integration and supported scenarios for Vehicle Weapon System"
product: weapon
...
for first setup. This page explains the complete runtime contract,
installation patterns, and advanced integration.
